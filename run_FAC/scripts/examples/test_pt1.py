...
ConfigEnergy(0)         # Calculates the average energy of configurations
OptimizeRadial(['grd.1']) # Obtaines optimal radial potential for list of cofigs
ConfigEnergy(1)         # Recalculates average energy after optimized potential
...
# Loop over types
for typ1 in list(groups.keys()).remove('grd'):
    # Loop over states
    for st1 in groups[typ1]:
