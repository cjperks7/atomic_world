...
config['optics']['detector']['zaxis']  = [0.0, 0.0, -1] # Normal direction of optic
config['optics']['detector']['xsize']  = 0.2 # Horizontal size
config['optics']['detector']['ysize']  = 0.2 # Vertical size
